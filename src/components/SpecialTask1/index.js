            ...
            <div className="page page--marginLeft50">
                <section className="page__section">
                    ...
                    <div className="page__row page__row--widthM page__row--marginBottomBig">
                        ...
                        <IntlContextConsumer>
                            {context => {
                                return <Radio options={[{ text: context.intl.formatMessage({ id: "intl.specialtask1.q1a1" }), value: 1 }, { text: context.intl.formatMessage({ id: "intl.specialtask1.q1a2" }), value: 2 }, { text: context.intl.formatMessage({ id: "intl.specialtask1.q1a3" }), value: 3 }]} />;
                            }}
                        </IntlContextConsumer>
                    </div>
                    <div className="page__row page__row--widthM page__row--marginBottomBig">
                        ...
                        <IntlContextConsumer>
                            {context => {
                                return <Radio options={[{ text: context.intl.formatMessage({ id: "intl.specialtask1.q2a1" }), value: 1 }, { text: context.intl.formatMessage({ id: "intl.specialtask1.q2a2" }), value: 2 }, { text: context.intl.formatMessage({ id: "intl.specialtask1.q2a3" }), value: 3 }]} />;
                            }}
                        </IntlContextConsumer>
                    </div>
                    <div className="page__row page__row--widthM page__row--marginBottomBig">
                        ...
                        <IntlContextConsumer>
                            {context => {
                                return <Radio options={[{ text: context.intl.formatMessage({ id: "intl.specialtask1.q3a1" }), value: 1 }, { text: context.intl.formatMessage({ id: "intl.specialtask1.q3a2" }), value: 2 }, { text: context.intl.formatMessage({ id: "intl.specialtask1.q3a3" }), value: 3 }]} />;
                            }}
                        </IntlContextConsumer>
                    </div>
